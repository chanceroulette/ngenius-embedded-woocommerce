 ...
 * @since 1.5.0
 */
final class NgeniusEmbeddedBlocksSupport extends AbstractPaymentMethodType
{
    /**
    ...
    public function enqueue_ngenius_blocks_styles()
    {
        if (is_checkout()) {
            wp_enqueue_style(
                ...
                NGENIUS_EMBEDDED_URL . '/resources/css/style.css',
                [],
                NGENIUS_EMBEDDED_VERSION
            );
        }
    }
    ...
    {
        $asset_path   = NGENIUS_EMBEDDED_PATH . '/resources/js/index.asset.php';
        $version      = NGENIUS_EMBEDDED_VERSION;
        $dependencies = [];
        ...
        wp_register_script(
            ...
            NGENIUS_EMBEDDED_URL . '/resources/js/index.js',
            $dependencies,
            $version,
            true
        );
    ...
    public function get_payment_method_data()
    {
        return [
            ...
            'logo_url'    => NGENIUS_EMBEDDED_URL . '/resources/network_logo.png',
        ];
    }
