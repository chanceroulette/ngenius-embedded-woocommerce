...
/**
 * NgeniusEmbeddedGatewayConfig class.
 */
class NgeniusEmbeddedGatewayConfig
{
    /**
     * Config tags
     */
     ...
     * Constructor.
     *
     * @param NgeniusEmbeddedGateway $gateway N-Genius gateway object.
     */
    public function __construct(NgeniusEmbeddedGateway $gateway, $order = "")
    {
        $this->order   = $order;
    ...
    public function should_use_outlet_override_ref(): bool
    {
        ...
        if (is_array($overriddenCurrencies)) {
            ...
            foreach ($overriddenCurrencies as $overriddenCurrency) {
                if ($orderCurrency === NgeniusEmbeddedSettings::$currencies[intval($overriddenCurrency)]) {
                    return true;
                }
            }
        }
