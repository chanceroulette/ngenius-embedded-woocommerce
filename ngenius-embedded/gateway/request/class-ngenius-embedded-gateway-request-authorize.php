...
/**
 * NgeniusEmbeddedGatewayRequestAuthorize class.
 */
class NgeniusEmbeddedGatewayRequestAuthorize extends NgeniusEmbeddedGatewayRequestAbstract
{
    /**
    ...
    public function get_build_array($order)
    {
        ...
        return [
            'data'   => [
                ...
                'merchantAttributes'     => [
                    'redirectUrl'          => add_query_arg('wc-api', 'ngenius_embedded', home_url('/')),
